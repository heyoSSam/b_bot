START_GUIDE_TEXT = """Привет. Доступные команды:

/beat - один mp3: название, обложка и авторы
/beatpack - несколько mp3: название для каждого бита, общая обложка и авторы
/set_channel - сохранить канал для подписи
/set_style - настроить шаблон подписи
